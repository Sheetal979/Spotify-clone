    ...
    <>
     <div className='w-full flex justify-between items-center font-semibold'>
        ...
        <div className='flex items-center gap-2'>
          ...
          <p className='bg-black text-white cursor-pointer'>Sign up</p>
          <p className='bg-white text-black py-1 px-3 font-bold h-[50px] w-[90px] rounded-full flex items-center justify-center cursor-pointer'>Log in</p>
        </div>
    </div> 
